...
INSERT INTO TRIGGER(ID, ENABLED, INPUT, INPUT_TYPE, ACTION_TYPE, CRON) VALUES ('734b1ce9-05eb-46b8-8d87-50cdbc4bbce2', 1, 'Hello Cron!', 2, 1,  '*/10 * * * * *');
...
INSERT INTO TEMPLATE(ID, TEMPLATE) VALUES (4, '{"name": "SOME_TABLE Report 2","owner": "me","visibility": {"type": "PUBLIC","value": null},"globalFilters": [{"column": "SALES_DATE","operator": "LESS_THAN_OR_EQUAL","value": "TODAY"}],"sections": [{"name": "Section 1","type": "REPORT","query": "SELECT ID, SALES_DATE, QUANTITY, PRICE FROM SOME_TABLE;","columns": [{"name": "ID","type": "NUMBER"},{"name": "SALES_DATE","type": "DATE"},{"name": "QUANTITY","type": "NUMBER"},{"name": "PRICE","type": "NUMBER"}],"report": {"dimensions": ["ID","SALES_DATE"],"facts": ["QUANTITY","PRICE"],"initialReport": {"dimensions": ["SALES_DATE"],"facts": ["QUANTITY","PRICE"]}},"dataGrid": null,"params": null},{"name": "Section 1","type": "REPORT","query": "SELECT ID, SALES_DATE, QUANTITY, PRICE FROM SOME_TABLE;","columns": [{"name": "ID","type": "NUMBER"},{"name": "SALES_DATE","type": "DATE"},{"name": "QUANTITY","type": "NUMBER"},{"name": "PRICE","type": "NUMBER"}],"report": {"dimensions": ["ID","SALES_DATE"],"facts": ["QUANTITY","PRICE"],"initialReport": {"dimensions": ["SALES_DATE"],"facts": ["QUANTITY","PRICE"]}},"dataGrid": null,"params": null},{"name": "Section 2","type": "DATA_GRID","query": "SELECT ID, INPUT, CRON FROM TRIGGER;","columns": [{"name": "ID","type": "TEXT"},{"name": "INPUT","type": "TEXT"},{"name": "CRON","type": "TEXT"}],"report": null,"dataGrid": {"actions": [{"name": "Log it","action": "LOG","url": "ID[${ID}] CRON[${CRON}] SQL[${SQL}]","type": null,"headers": null,"data": [{"ID": "ID"},{"SQL": "INPUT"},{"CRON": "CRON"}]},{"name": "Also Log it","action": "LOG","url": "https://localhiost:8080/get/${ID}/delete","type": null,"headers": null,"data": [{"ID": "ID"}]}]},"params": null}]}');
