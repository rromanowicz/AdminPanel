INSERT INTO T_TRIGGER(ID, ENV, ENABLED, CYCLIC, INPUT, INPUT_TYPE, ACTION_TYPE, CRON) VALUES ('734b1ce9-05eb-46b8-8d87-50cdbc4bbce1', 1, 0, 0, 'SELECT * FROM TRIGGER;', 0, 0,  '0,30 * * * * *');
