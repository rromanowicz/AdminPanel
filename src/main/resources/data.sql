INSERT INTO T_TRIGGER(ID, NAME, ENV, ENABLED, CYCLIC, INPUT, INPUT_TYPE, ACTION_TYPE, CRON) VALUES ('734b1ce9-05eb-46b8-8d87-50cdbc4bbce1', 'Simple select.', 1, 0, 0, 'SELECT * FROM SOME_TABLE', 0, 0,  '0,30 * * * * *');
INSERT INTO T_TRIGGER(ID, NAME, ENV, ENABLED, CYCLIC, INPUT, INPUT_TYPE, ACTION_TYPE, CRON) VALUES ('734b1ce9-05eb-46b8-8d87-50cdbc4bbce2', 'Print text,', 1, 0, 0, 'Hello Cron!', 2, 1,  '*/10 * * * * *');
